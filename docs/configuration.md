...
| `printFormTimerInterval` | int | `300` | 印刷フォームのタイマーインターバル (ミリ秒)。最小値は 1 |
...
| `printFormTimerInterval` | DirectPrintService.xml / BatchPrintService.xml | 300 | ms | スプール状態チェックのタイマー間隔 | - |
