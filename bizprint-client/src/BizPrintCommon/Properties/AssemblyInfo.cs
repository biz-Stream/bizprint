...
[assembly: Guid("097114a1-d8ea-4682-9484-fb9bc6bb8b53")]
...
//[assembly: log4net.Config.XmlConfigurator(Watch = true, ConfigFile = "SilentPdfPrinter_logConfig.xml")]
//log4netの設定は、自分で指定するように変更したため不要(複数プログラムからの使用を前提とするため)
