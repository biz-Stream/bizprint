...
InfoFileArray = ["BizPrintCommon/Properties/AssemblyInfo.cs",
"SilentPdfPrinter/Properties/AssemblyInfo.cs",
"DirectPrintService/Properties/AssemblyInfo.cs",
"BatchPrintService/Properties/AssemblyInfo.cs",
"SppFileExtractTool/Properties/AssemblyInfo.cs"
]
...
def mkIns( srcDir )
  ...
  callVsCmdBld( srcDir + "BizPrintClient.sln")
end
